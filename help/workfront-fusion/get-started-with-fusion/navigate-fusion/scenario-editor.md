...
| Sökmoduler <p>![Sökmoduler](assets/search-modules-icon.png)  </p> | Ange en sökterm för att söka efter en modul och klicka sedan på sökresultaten som ska hämtas till den modulen. Du kan söka efter modulnamn, ID, typ eller program. |
