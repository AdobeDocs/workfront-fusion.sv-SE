...
## API-anslutning och moduler för Adobe-användarhantering är nu tillgängliga

Nu kan du använda Workfront Fusion för att hantera Adobe-användare i organisationen. Med Adobe moduler för användarhantering kan du
...
Mer information och instruktioner finns i [Modulerna för Adobe-användarhantering](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/adobe-user-management-modules.md).
