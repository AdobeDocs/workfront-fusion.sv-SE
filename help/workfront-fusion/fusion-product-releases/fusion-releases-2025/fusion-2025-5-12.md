...
## Ny anslutningstyp tillgänglig i Azure DevOps-anslutning

För att göra det enklare att begära alla scope när en anslutning konfigureras i Azure DevOps har vi skapat en ny typ av anslutning. Anslutningstypen Azure DevOps EntraApp innehåller en växlingsknapp som gör att du kan begära alla scope för anslutningen.
