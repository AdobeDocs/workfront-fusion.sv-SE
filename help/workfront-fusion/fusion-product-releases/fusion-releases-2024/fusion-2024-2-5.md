...
Adobe Authenticator-modulen gör det enklare att ansluta till alla Adobe-program-API:er. I stället för att använda HTTP-modulerna kan du nu använda Adobe Authenticator-modulen för att ansluta till Adobe-produkter som för närvarande inte har någon dedikerad Fusion-anslutning.
