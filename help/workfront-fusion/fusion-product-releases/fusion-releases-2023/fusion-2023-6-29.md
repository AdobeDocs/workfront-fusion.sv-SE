...
* Uppdaterat PDF till Image-modulen: I modulen PDF till Image kan du nu välja om du vill skriva ut en zip-fil eller en lista med bilder.
* Ny Dela upp PDF-modul: Använd den här modulen för att dela upp en PDF i mindre PDF-filer. Du kan dela efter antal filer, sidor per fil eller sidintervall.
* Ny PDF Accessibility Auto-Tag-modul: Använd den här modulen för att tagga en PDF och skapa en tillgänglighetsrapport. PDF-filer som är taggade för tillgänglighet ger skärmläsare större precision när layoutfunktioner som rubriker och tabeller identifieras.
