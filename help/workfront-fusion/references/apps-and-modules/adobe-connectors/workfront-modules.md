...
Modulen visar alla händelseprenumerationer som är relaterade till webkroken. Detta inkluderar händelseprenumerationer som skapats via Fusion samt händelseprenumerationer som skapats direkt via API:t. Den här prenumerationsvyn för händelser är inte tillgänglig i den äldre versionen av modulen Bevaka händelser.
