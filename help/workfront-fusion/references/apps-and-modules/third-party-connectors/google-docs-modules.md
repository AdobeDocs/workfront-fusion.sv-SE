...
Med Adobe Workfront Fusion [!DNL Google Docs]-modulerna kan du övervaka, skapa, redigera och hämta dokument i [!DNL Google Docs] och [!DNL Google Docs] (för [!DNL Google Workspace] användare).
