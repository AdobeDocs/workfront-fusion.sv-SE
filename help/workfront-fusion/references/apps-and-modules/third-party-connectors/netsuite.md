...
I ett Adobe Workfront Fusion-scenario kan du automatisera arbetsflöden som använder [!DNL NetSuite] samt ansluta det till flera tredjepartsprogram och -tjänster.
...
1. Klicka på [!DNL NetSuite] bredvid rutan Anslutning i modulen **[!UICONTROL Add]**.
...
När du konfigurerar [!DNL NetSuite]-moduler visas fälten som listas nedan i Workfront Fusion. Dessutom kan ytterligare [!DNL NetSuite] fält visas, beroende på faktorer som din åtkomstnivå i appen eller tjänsten. En rubrik med fet stil i en modul visar ett obligatoriskt fält.
